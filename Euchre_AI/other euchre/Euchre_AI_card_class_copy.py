    ...
    def euchre_round(self, dealer, trump_info_list, trump_suit_card, trump_suit, trump_card):
        ...
        while total_hands < 5:
            ...
            for i in range(len(deck_order_c)):
                ...
                player_index = Euchre.players.index(player)
                print("deck order standard before remove statement in euchre_round = " + str(Euchre.deck_order_standard[player_index]))
                print("deck_order_c[i] before remove " + str(deck_order_c[i]))
                deck_order_c[i].remove(card_choice)
                print("deck order standard after remove statement in euchre_round = " + str(Euchre.deck_order_standard[player_index]))
                print("deck_order_c[i] after remove " + str(deck_order_c[i]))
...
class AI:
    ...
    def dealer_removal_choice(self, player_deck, trump_suit, trump_card, dealer_index):
        ...
        #testprint
        print("player_deck_c in dealer_removal_choice = " + str(player_deck_c))
        print("trump_suit = " + str(trump_suit))
