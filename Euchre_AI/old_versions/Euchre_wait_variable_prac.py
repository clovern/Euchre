...
class Euchre(Card_game):
    ...
    def euchre_round(self, dealer, trump_info_list, trump_suit_card, trump_suit, trump_card):
        ...
        # while total_hands < 5:
            ...
            # player_order, deck_order_c = self.set_starting_player(winning_player, total_hands, self.dealer, loner_player)
            ####
            #testprint
    ...
    def set_orders(self):
        ...
        trump_info_list = self.pick_up(trump_card, trump_suit, self.dealer, self.dealer_index, player_order, deck_order)        
    ...
    def pick_up(self, trump_card, trump_suit, dealer, dealer_index, player_order, deck_order):
        ...
        for i in range(len(player_order)):
            ...
            player_label = Label(window, text = player.name).grid(column = 0, row = 5)
