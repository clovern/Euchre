...
class Window(Tk):
    player1name, player2name, player3name, player4name = None, None, None, None
    def __init__(self):
    ...
    #    Window.player1name, Window.player2name, Window.player3name, Window.player4name = self.player1name.get(), self.player2name.get(), self.player3name.get(), self.player4name.get()
    #    self.delete_window_widgets()
            
    #    entered_teams_label = ttk.Label(self, text = "Team 1 = {} and {} \nTeam 2 = {} and {}".format(Window.player1name, Window.player3name, \
    #    Window.player2name, Window.player4name)).grid(column = 0, row = 0)
        
    #    self.now_beginning_label = ttk.Label(self, text = "Your Euchre game is about to begin").grid(column = 0, row = 1)
    #    self.after(5000, self.delete_window_widgets)    
...
class Euchre(Card_game):
    ...
    def euchre_greeting(self):
        ...
        #done_enter_names_button = ttk.Button(window, text = "Done Entering Names", command = window.delete_window_widgets).grid(column = 1, row = 10)
        
        #print("Window.player names")
        #print(Window.player1name, Window.player2name, Window.player3name, Window.player4name)
