...
class Euchre(Card_game):
    ...
    def pick_up_scene(self):
        ...
        self.instructions_label = Label(window, text = "                                                      \n\n".format(self.human_player.name))
        self.instructions_label.grid(column = 0, row = 1)
...
class Player:
    ...
    def pick_up_questions_1(self, i, trump_card, trump_suit, dealer, player, dealer_index, player_deck):
        game_1.instructions_label.configure(text = "{}, will you tell the dealer to pick it up?\n\n".format(player.name))
        #window.update()
