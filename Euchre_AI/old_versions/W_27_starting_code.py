...
class Euchre(Card_game):
    ...
    def hand_winner_announcement(self):
        ...
        if winning_team == Euchre.team_1:
            ...
            winning_team_string = "The AI Team"
...
class AI:
    ...
    def call_suit_4_card(self, list, other_suits_in_deck, other_cards_in_deck, dec_num, loner_dec_num):
        ...
        comp_deck_ct_5 = len([i for i in list if i in ["ace", "jack", "jack_lft"]])
        ...
        if comp_deck_ct_5 == 4:
            if comp_deck_ct_5 == 0:
                ...
                loner_player, called_suit = "yes", list[0] if loner_dec_num <.85 else "no", list[0]
        elif comp_deck_ct_2 == 3:
            #print("2")
            if comp_deck_ct_4 == 1:
                loner_player, called_suit = "no", list[0]
            else:
                loner_player, called_suit = "yes", list[0] if loner_dec_num < .75 else "no", list[0]
    ...
    def call_suit_3_card(self, list, other_suits_in_deck, offsuit_cards_in_deck, dec_num, loner_dec_num):
        ...
        if comp_deck_ct_1 == 3:
            ...
            if comp_deck_ct_6 == 0:
                loner_player, called_suit = "yes", list[0] if loner_dec_num < .75 else "no", list[0]
            elif comp_deck_ct_6 == 1:
                loner_player, called_suit = "yes", list[0] if loner_dec_num < .45 else "no", list[0]
            else:
                loner_player, called_suit = "yes", list[0] if loner_dec_num < .15 else "no", list[0]
