...
class Euchre(Card_game):
    ...
    def set_orders(self):
        ...
        trump_info_list = self.pick_up(trump_card, trump_suit, self.dealer, self.dealer_index, self.player_order, self.deck_order)        
    ...
    def pick_up(self, trump_card, trump_suit, dealer, dealer_index, player_order, deck_order):
        ...
        for i in range(len(self.player_order)):
            player, player_deck = self.player_order[i], deck_order[i]
            column_counter = 0
            ...
            trump_info_list = player.pick_up_questions_1(i, trump_card, trump_suit, self.dealer, player, \
