...
class Euchre(Card_game):
    ...
    def show_trump(self):
        ...
        self.now_beginning_label = ttk.Label(central_labelframe, image = trump_pic)
        self.now_beginning_label.grid(column = 0, row = 1)
    ...
    def euchre_round_set_scene(self):
        ...
        AI_1_icon = Label(window, image = Euchre.players[1].get_pic())
        AI_1_icon.grid(column = 0, row = 0)
        
        AI_2_labelframe = LabelFrame(window, text = "AI 1")
        AI_2_labelframe.grid(column = 0, row = 4)
        AI_2_icon = Label(window, image = Euchre.players[2].get_pic())
        AI_2_icon.grid(column = 0, row = 0)
        
        AI_3_labelframe = LabelFrame(window, text = "AI 1")
        AI_3_labelframe.grid(column = 0, row = 5)
        AI_3_icon = Label(window, image = Euchre.players[3].get_pic())
        ...
        # while total_hands < 5:
            ...
            # for i in range(len(deck_order_c)):
                ...
                # if type(player) == Player:
                    ...
                    #player.card_choice_question(i, player, player_deck, laid_down, round_players)
                    ####
                    #testprint
...
class Player:
    ...
    def card_choice_question(self, i, player, player_deck, laid_down, round_players):
        pass
