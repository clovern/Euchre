    ...
    def normal_card_choice_question(self, i, player_deck):
        ...
        if led_suit_in_hand:
            ...
            if Euchre.player_opposites[player] in game_1.round_players and current_winning_player == Euchre.player_opposites[player]:
                ...
                middle_card_index = None
                highest_card_index = choosing_deck_values.index(max(choosing_deck_values))
                for value in choosing_deck_values:
                    if choosing_deck_values.index(value) != lowest_card_index and choosing_deck_values.index(value) != highest_card_index:
                        middle_card_index = choosing_deck_values.index(value)
                print("choosing_deck[highest_card_index] =" + str(choosing_deck[highest_card_index]))
                potential_card = None
                max_or_min = lowest_card_index
                while True:
                    print("lowest_card_index, highest_card_index, max_or_min")
                    ...
                    if potential_laid_down[potential_winner_index] == potential_card:
                        ...
                        if max_or_min == lowest_card_index and lowest_card_index != highest_card_index:
                            if middle_card_index != None:
                                max_or_min = middle_card_index
                            else:
                                max_or_min = highest_card_index
                        elif max_or_min == middle_card_index:
                            max_or_min = highest_card_index
                        else:
                            break
