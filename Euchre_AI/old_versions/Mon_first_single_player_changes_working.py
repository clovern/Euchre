...
class Euchre(Card_game):
    ...
    def pick_up_scene(self):
        ...
        self.pick_up_button = ttk.Button(window, text = "Pick up", state = "disabled", command = lambda: self.pick_up_decision(i, player_responses, "no"), ).grid(column = 2, row = 5)
        self.loner_button = ttk.Button(window, text = "Pick up and Go Alone", state = "disabled", command = lambda: self.pick_up_decision(i, player_responses, game_1.player_order[i])).grid(column = 3, row = 5)
        self.pass_button = ttk.Button(window, text = "Pass", state = "disabled", command = lambda: self.pass_decision(i, player_responses)).grid(column = 4, row = 5)
        column_counter = 2
        ...
        self.player_response_list = ["Has not gone yet", "Has not gone yet", "Has not gone yet", "Has not gone yet"]
    ...
    def pick_up_decision(self, i = 0, player_responses = [None, None, None, None]):
        if i >= 4:
        ...
        # else:
            ...
            # for person in self.player_order:
                # if person != player:
                    ...
                    # column_counter += 1
            # if type(self.player_order[i-1]) == AI:
                # window.after(1000)
...
class Player:
    ...
    def pick_up_questions_1(self, i, trump_card, trump_suit, dealer, player, dealer_index, player_deck, player_responses):
        ...
        self.pick_up_button.configure(state = "normal")
        self.loner_button.configure(state = "normal")
    ...
    def pass_decision(self, i, player_responses):
        ...
        self.pick_up_button.configure(state = "disabled")
        self.loner_button.configure(state = "disabled")
        self.pass_button.configure(state = "disabled")
        game_1.pick_up(i = i+1, player_responses = player_responses)
...
class AI:
    ...
    def pass_decision(self, i, player_responses):
        print("in pass decision")
        self.player_response_label_list.configure(text = "deciding")
        window.after(1000)
        self.player_response_label_list.configure(text = "pass")
