...
class Euchre(Card_game):
    ...
    def euchre_round_set_scene_pt_2(self):
        ...
        for item in Euchre.deck_order_standard[0]:
            ...
            counter += 1
        # counter_2 = 9
        # for item in self.space_filler_labels[:-(self.total_hands)]:
            # item.grid(column = counter_2, row = 5)
            # counter_2 -= 1
...
class Player:
    ...
    def human_card_choice_check(self, n):
        ...
        if renege_pass_fail == "all clear":
            ...
            labelframe_text = human_player.name if human_player.name != ("" or " "  or "  " or None) else "You"
