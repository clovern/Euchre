...
class Player:
    ...
    def card_choice_question(self, i, player_deck):
        ...
        self.tell_hand_buttons_list = [game_1.clb_1, game_1.clb_2, game_1.clb_3, game_1.clb_4, game_1.clb_5]
        for button in self.tell_hand_buttons_list:
    ...
    def human_card_choice_check(self, n):
        ...
        self.tell_hand_buttons_list[n].configure(image = Euchre.empty_potential_trump)
...
class AI:
    ...
    def normal_card_choice_question(self, i, player_deck):
        ...
        left_bower = Euchre.left_bowers[game_1.trump_suit]
        current_winner_index = game_1.determine_highest(game_1.trump_suit, game_1.laid_down)
        ...
        if led_suit_in_hand:
            ...
            if Euchre.player_opposites[player] in game_1.round_players and current_winning_player == Euchre.player_opposites[player]:
                ...
                potential_winner_index = game_1.determine_highest(game_1.trump_suit, game_1.laid_down)
