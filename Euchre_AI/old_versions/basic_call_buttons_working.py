...
class Player:
    ...
    def pick_up_questions_1(self, i, trump_card, trump_suit, dealer, player, dealer_index, player_deck, player_responses):
        ...
        pick_up_button = ttk.Button(window, text = "Pick up", command = lambda: self.pick_up_decision(i, player_responses)).grid(column = 2, row = 4)
        loner_button = ttk.Button(window, text = "Pick up and Go Alone", command = lambda: self.loner_decision(i, player_responses)).grid(column = 3, row = 4)
    ...
    def pick_up_decision(self, i, player_responses):
        print("in pick_up_decision")
        pass
    
    def loner_decision(self, i, player_responses):
        print("in loner_decision")
        pass
...
your hand to discard. Please enter the number of your chosen card here: ".format(trump_card, trump_suit)
    ...
    def call_it_decision_1(self, i, player_responses, loner_decision):
        ...
        call_spades_button = ttk.Button(window, text = "call spades", command = lambda: self.call_it_decision_2(i, player_responses, "spades")).grid(column = 2, row = 4)
        call_clubs_button = ttk.Button(window, text = "call clubs", command = lambda: self.call_it_decision_2(i, player_responses, "clubs")).grid(column = 3, row = 4)
        call_diamonds_button = ttk.Button(window, text = "call diamonds", command = lambda: self.call_it_decision_2(i, player_responses, "diamonds")).grid(column = 4, row = 4)
        call_hearts_button = ttk.Button(window, text = "call hearts", command = lambda: self.call_it_decision_2(i, player_responses, "hearts")).grid(column = 5, row = 4)

    
    def call_it_decision_2(self, i, player_responses):
        return
