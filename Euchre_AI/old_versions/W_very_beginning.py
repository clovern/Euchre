...
class Card():
    ...
    nine_of_hearts_pic_small = (Image.open("9_of_hearts.png")).resize((160, 110))
    nine_of_hearts_pic_small = ImageTk.PhotoImage(nine_of_hearts_pic_small)
    nine_of_diamonds_pic_small = (Image.open("9_of_diamonds.png")).resize((160, 110))
    nine_of_diamonds_pic_small = ImageTk.PhotoImage(nine_of_diamonds_pic_small)
    nine_of_clubs_pic_small = (Image.open("9_of_clubs.png")).resize((160, 110))
    nine_of_clubs_pic_small = ImageTk.PhotoImage(nine_of_clubs_pic_small)
    nine_of_spades_pic_small = (Image.open("9_of_spades.png")).resize((160, 110))
    nine_of_spades_pic_small = ImageTk.PhotoImage(nine_of_spades_pic_small)
    
    
    ten_of_hearts_pic_small = (Image.open("10_of_hearts.png")).resize((160, 110))
    ten_of_hearts_pic_small = ImageTk.PhotoImage(ten_of_hearts_pic_small)
    ten_of_diamonds_pic_small = (Image.open("10_of_diamonds.png")).resize((160, 110))
    ten_of_diamonds_pic_small = ImageTk.PhotoImage(ten_of_diamonds_pic_small)
    ten_of_spades_pic_small = (Image.open("10_of_spades.png")).resize((160, 110))
    ten_of_spades_pic_small = ImageTk.PhotoImage(ten_of_spades_pic_small)
    ten_of_clubs_pic_small = (Image.open("10_of_clubs.png")).resize((160, 110))
    ten_of_clubs_pic_small = ImageTk.PhotoImage(ten_of_clubs_pic_small)
    
    jack_of_hearts_pic_small = (Image.open("jack_of_hearts.png")).resize((160, 110))
    jack_of_hearts_pic_small = ImageTk.PhotoImage(jack_of_hearts_pic_small)
    jack_of_diamonds_pic_small = (Image.open("jack_of_diamonds.png")).resize((160, 110))
    jack_of_diamonds_pic_small = ImageTk.PhotoImage(jack_of_diamonds_pic_small)
    jack_of_spades_pic_small = (Image.open("jack_of_spades.png")).resize((160, 110))
    jack_of_spades_pic_small = ImageTk.PhotoImage(jack_of_spades_pic_small)
    jack_of_clubs_pic_small = (Image.open("jack_of_clubs.png")).resize((160, 110))
    jack_of_clubs_pic_small = ImageTk.PhotoImage(jack_of_clubs_pic_small)
    
    queen_of_hearts_pic_small = (Image.open("queen_of_hearts.png")).resize((160, 110))
    queen_of_hearts_pic_small = ImageTk.PhotoImage(queen_of_hearts_pic_small)
    queen_of_diamonds_pic_small = (Image.open("queen_of_diamonds.png")).resize((160, 110))
    queen_of_diamonds_pic_small = ImageTk.PhotoImage(queen_of_diamonds_pic_small)
    queen_of_spades_pic_small = (Image.open("queen_of_spades.png")).resize((160, 110))
    queen_of_spades_pic_small = ImageTk.PhotoImage(queen_of_spades_pic_small)
    queen_of_clubs_pic_small = (Image.open("queen_of_clubs.png")).resize((160, 110))
    queen_of_clubs_pic_small = ImageTk.PhotoImage(queen_of_clubs_pic_small)
    
    king_of_hearts_pic_small = (Image.open("king_of_hearts.png")).resize((160, 110))
    king_of_hearts_pic_small = ImageTk.PhotoImage(king_of_hearts_pic_small)
    king_of_diamonds_pic_small = (Image.open("king_of_diamonds.png")).resize((160, 110))
    king_of_diamonds_pic_small = ImageTk.PhotoImage(king_of_diamonds_pic_small)
    king_of_spades_pic_small = (Image.open("king_of_spades.png")).resize((160, 110))
    king_of_spades_pic_small = ImageTk.PhotoImage(king_of_spades_pic_small)
    king_of_clubs_pic_small = (Image.open("king_of_clubs.png")).resize((160, 110))
    king_of_clubs_pic_small = ImageTk.PhotoImage(king_of_clubs_pic_small)
    
    ace_of_hearts_pic_small = (Image.open("ace_of_hearts.png")).resize((160, 110))
    ace_of_hearts_pic_small = ImageTk.PhotoImage(ace_of_hearts_pic_small)
    ace_of_diamonds_pic_small = (Image.open("ace_of_diamonds.png")).resize((160, 110))
    ace_of_diamonds_pic_small = ImageTk.PhotoImage(ace_of_diamonds_pic_small)
    ace_of_spades_pic_small = (Image.open("ace_of_spades.png")).resize((160, 110))
    ace_of_spades_pic_small = ImageTk.PhotoImage(ace_of_spades_pic_small)
    ace_of_clubs_pic_small = (Image.open("ace_of_clubs.png")).resize((160, 110))
...
class Euchre(Card_game):
    ...
    def euchre_round_set_scene(self):
        ...
        tell_hand_label = Label(text = "The cards in your hand are: \n")
        tell_hand_label.place(relx = .4, rely = .55)
    ...
    def euchre_full_hand(self, i = 0):
        self.player_order = None, self.deck_order = None
        if total_hands > 5:
            return
        else:
            ...
            self.laid_down = []
            self.round_players = []
            #sets self.player_order and self.player_decks
            self.euchre_trick()
...
class Player:
    ...
    def card_choice_question(self, i):
        ...
        tell_hand_buttons_list = [self.clb_1, self.clb_2, self.clb_3, self.clb_4, self.clb_5]
        for button in tell_hand_buttons_list:
            button.configure(state = "normal", command = )

    def human_card_choice_check(n)
        
        card_choice = (Euchre.deck_order_standard[0])[n]
        tell_hand_buttons_list = [self.clb_1, self.clb_2, self.clb_3, self.clb_4, self.clb_5]
        tell_hands_buttons_list[n].destroy()
        self.card_choice_label = Label(window, image = card_choice.get_small_pic)
        self.card_choice_label.grid(column = 
...
class AI:
    ...
    def first_chooser_card_choice(self, i, player_deck):
        ...
        self.laid_down.append(card_to_play)
        self.round_players.append(self.player_order[i])
        sets self.player_order and self.player_decks
        return card_to_play
