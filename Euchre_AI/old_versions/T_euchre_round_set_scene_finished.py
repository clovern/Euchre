...
class Euchre(Card_game):
    ...
    def euchre_round_set_scene(self):
        ...
        for item in Euchre.deck_order_standard[0]:
            ...
            self.buttons_list[n].configure(image = card_picture, state = "disabled", command = lambda n = n, counter = counter: self.dealer_removal_replace(n, counter))
    ...
    def euchre_round(self):
        dealer_pickup_yn, player_picked_up, trump_suit, loner_player = self.trump_info_list[0], self.trump_info_list[1], \
        self.trump_info_list[2], self.trump_info_list[3]
        team_picked_up = self.team_1 if player_picked_up in self.team_1 else self.team_2
        self.team_1_hands_won, self.team_2_hands_won = 0, 0
        self.total_hands = (self.team_1_hands_won + self.team_2_hands_won)
        self.winning_player = "" 
        #self.last_hand_winning_card = ["", ""]
        ...
        # while total_hands < 5:
            ...
            # self.player_order, deck_order_c = self.set_starting_player(self.winning_player, self.total_hands, self.dealer, loner_player)
            ####
            #testprint
