...
class Player:
    ...
    def player_is_dealer(self, i, player_is_dealer = "no"):
        ...
        for item in deck:
            ...
            self.buttons_list[n].configure(image = card_picture, command = lambda n = n: self.dealer_removal_replace(n, counter))
    ...
    def dealer_removal_replace(self, card_choice_index, counter):
        ...
        print("card_choice_index in dealer_removal_replace = " + str(card_choice_index))
