...
class Euchre(Card_game):
    ...
    def show_trump(self):
        ...
        print("SELF.TRUMPINFOLIST" + str(self.trump_info_list))
    ...
    def show_highest(self):
        ...
        self.total_hands = self.team_1_hands_won + self.team_2_hands_won
        print("self.total_hands. self.team_1_hands_won, self.team_2_hands_won in show_highest = ")
        print(self.total_hands, self.team_1_hands_won, self.team_2_hands_won)
    ...
    def clear_for_next_trick(self):
        print("self.total_hands. self.team_1_hands_won, self.team_2_hands_won in clear for next trick = ")
        print(self.total_hands, self.team_1_hands_won, self.team_2_hands_won)
        self.laid_down = []
        self.round_players = []
    ...
    def euchre_full_hand(self, i = 0):
        ...
        if self.total_hands == 5:
            print("\n\n REACHED TOTAL HANDS > 5 IN EUCHRE FULL HAND \n\n")
    ...
    def hand_winner_announcement(self):
        ...
        print("team picked up" + str(self.team_picked_up))
        print("winning team, points awarded")
    ...
    def euchre_shuffle(self):
        ...
        print("LEFTOVER DECK = " + str(Euchre.leftover_deck))
    ...
    def pick_up_scene(self):
        ...
        print("missing AI name =" + str(missing_AI_name)) 
...
class Player:
    ...
    def pick_up_decision(self, i, loner_decision):
        print("human player decided to pick up")
    ...
    def human_card_choice_check(self, n):
        ...
        if renege_pass_fail == "all clear":
            ...
            print("human card choice = " + str(card_choice))
            ...
            print("game_1.human_player.name = " + str(game_1.human_player.name))
            print("labelframe text = " + str(labelframe_text))
...
class AI:
    ...
    def pick_up_questions_1(self, i, trump_card, trump_suit, dealer, player, dealer_index, player_deck):
        #testprint
        print("player, player deck at beginning of pick_up_qs 1 = " + str(player.name) + "," + str(player_deck))
    ...
    def four_cards_trump(self, trumpst_card_names, unique_offsuits_num, off_trump_card_names, dec_num):
        ...
        #print("trumpst card names" + str(trumpst_card_names))
        #print("unique_offsuits_num =" + str(unique_offsuits_num))
        ...
        #print("comp decks")
        #print(comp_deck_ct_1, comp_deck_ct_2, comp_deck_ct_3, comp_deck_ct_4)
        #print("loner player, pick up decision = " + str(loner_player) + str(pick_up_decision))
    ...
    def dealer_removal_choice(self, player_deck, trump_suit, trump_card, dealer_index):
        print("dealer name, dealer_deck = " + str(game_1.dealer.name) + ", " + str(Euchre.deck_order_standard[game_1.dealer_index]))
        player_deck_c = player_deck.copy()
        ...
        #testprint
        print("dealer removal card choice = " + str(removal_card.get_card_name()))
    ...
    def pick_up_questions_2(self, i, trump_card, trump_suit, dealer, dealer_index, player, player_deck):
        ...
        #testprint
        print("player, player_deck coming in to pick up questions 2 = " + str(player.name) + ", " + str(player_deck))
        loner_player = "no"
        called_suit = None
        dec_num = random.random()
        ...
        #print("all suits nested list after stripping = " + str(all_suits_nested_list))
        for list in all_suits_nested_list:
            other_suits_in_deck = 0
            other_cards_in_deck = []
            list_suit = list[0]
            #print("suit, list in list loop = " + str(list_suit) + ", " + str(list))
            #print("length of that list is" + str(len(list)))
            ...
            for list2 in all_suits_nested_list:
                if list2[0] == list_suit_pair:
                    partner_list = list2
            if partner_list:
                #print("partner list found")
                if "jack" in partner_list:
                    #print("found jack in partner list")
                    list.append("jack_lft")
                    #print("list after left bower added" + str(list))
            ...
            for list3 in all_suits_nested_list:
                if list3 != list:
                    ...
                    #print("other cards in deck in this loop  = " + str(other_cards_in_deck))
                #print("other cards in deck after loop  = " + str(other_cards_in_deck))
            #print("got here")
            if len(list) - 1 == 5:
            ...
            #print("got to checkmark 2")
            if called_suit != None:
                print("called suit = " + str(called_suit))
    ...
    def call_suit_2_card(self, list, other_suits_in_deck, offsuit_cards_in_deck, dec_num):
        called_suit = None 
        #testprint (all throughout)
        #print("initiating call_suit_2_card")
        #print("dec_num = " + str(dec_num))
        #print("list = " + str(list))
        #print("other suits in deck = " + str(other_suits_in_deck))
        #print("offsuit_cards_in_deck = " + str(offsuit_cards_in_deck))
    ...
    def caller_force_choose(self, all_suits_nested_list):
        print("all suits nested list in caller force choose = " + str(all_suits_nested_list))
        ...
        if longcard_suit_list_length >= 5:
            #print("longcard_suit_list_length >= 5")
        ...
        print(longcard_suit_list)
        print(longcard_suit_list_length)
        print(strongcard_suit_list)
        print("caller force choose called suit = " + str(called_suit))
        return called_suit
    ...
    def first_chooser_card_choice(self, i, player_deck):
        ...
        #print("started going through first chooser card choice")
                #testprint
        print("player, player deck at beginning of first_chooser_card_choice = " + str(player.name) + "," + str(player_deck))
    ...
    def normal_card_choice_question(self, i, player_deck):
        player = game_1.player_order[i]
        #testprint
        print("player, player_deck_c in card_choice_questions AI = " + str(player.name) + ", " + str(player_deck))
        led_suit = (game_1.laid_down[0]).get_suit()
        ...
        print("trump suit in hand = " + str(trump_suit_in_hand))
        print("other_suits_in_hand_card = " + str(other_suits_in_hand_card))
        print("led_suit_in_hand = " + str(led_suit_in_hand))
        ...
        if led_suit_in_hand:
            ...
            choosing_deck_values_copy = choosing_deck_values.copy()
            if len(choosing_deck_values_copy) >= 3:
                print("LOOK HERE")
            if Euchre.player_opposites[player] in game_1.round_players and current_winning_player == Euchre.player_opposites[player]:
                ...
                lowest_card_index = choosing_deck_values_copy.index(min(choosing_deck_values_copy))
                initial_lowest_card_index = choosing_deck_values.index(min(choosing_deck_values))
                highest_card_index = choosing_deck_values.index(max(choosing_deck_values))
                print("choosing_deck[highest_card_index] =" + str(choosing_deck[highest_card_index]))
                potential_card = None
                max_or_min = initial_lowest_card_index
                while True:
                    print("choosing deck values" + str(choosing_deck_values))
                    print("choosing deck values copy" + str(choosing_deck_values_copy))
                    print("in while true 1")
                    if max_or_min == initial_lowest_card_index:
                        print("initial_lowest_card_index = " + str(choosing_deck_values[lowest_card_index]))
                    elif max_or_min == lowest_card_index:
                        print("lowest_card_index = " + str(choosing_deck_values_copy[lowest_card_index]))
                    else:
                        print("highest_card_index = " + str(choosing_deck_values[highest_card_index]))
                    if choosing_deck[max_or_min] == "jack_lft":
                        for card in player_deck:
                            if card == left_bower:
                                potential_card = card
                    for card in player_deck:
                        print("111111111111111111card name, card suit, choosing deck[max_or_min], trump_suit = ")
                        print(card.get_card_name(), card.get_suit())
                        print(choosing_deck[max_or_min], game_1.trump_suit)
                        if card.get_card_name() == choosing_deck[max_or_min] and card.get_suit() == led_suit:
                            print("found a match")
                            potential_card = card
                    potential_laid_down.append(potential_card)
                    print("potential card = " + str(potential_card))
                    ...
                    if potential_laid_down[potential_winner_index] == potential_card:
                        ...
                        print("IN HERE!!!")
                        if initial_lowest_card_index != highest_card_index and max_or_min != highest_card_index:
                            choosing_deck_values_copy[max_or_min] = 20
                            lowest_card_index = lowest_card_index
                            print(lowest_card_index)
                            print(initial_lowest_card_index)
                            print(highest_card_index)
                            cdvc_count = [i for i in choosing_deck_values_copy if i != 20 and i != choosing_deck_values[highest_card_index]]
                            print("c =" + str(cdvc_count))
                            print("cdvc_count = " + str(len(cdvc_count)))
                            if len(cdvc_count) != 0:
                                print("Code 1")
                                if max_or_min == initial_lowest_card_index:
                ...
                if card_to_play_index == None:
                    ...
                    #print("3, choosing deck, choosing deck_values, card_to_play_index = \n" + str(choosing_deck) + "\n" + str(choosing_deck_values) + 
                        # "\n" + str(card_to_play_index))
                print("card that would have won inthis = " + str(potential_laid_down[potential_winner_index]))
            ...
            choosing_deck_values = [Euchre.card_values_trump[card] for card in choosing_deck]
            print("choosing deck at 1 = " + str(choosing_deck))
            print("choosing deck values at 1 =" + str(choosing_deck_values))
            choosing_deck_values_copy = choosing_deck_values.copy()
            if len(choosing_deck_values_copy) >= 3:
                print("LOOK HERE")
            if len(choosing_deck_values_copy) >= 3:
            ...
            if current_winning_player == Euchre.player_opposites[player]:
                ...
                if i == (len(game_1.player_order) - 1):
                    ...
                    max_or_min = initial_lowest_card_index
                    while True:
                        print("choosing deck_values" + str(choosing_deck_values))
                        print("choosing deck values copy" + str(choosing_deck_values_copy))
                        ...
                        if choosing_deck[max_or_min] == "jack_lft":
                            for card in player_deck:
                                if card == left_bower:
                                    potential_card = card
                        for card in player_deck:
                            print("2222222222222222222card name, card suit, choosing deck[highest card index], trump_suit = ")
                            print(card.get_card_name(), card.get_suit())
                            print(choosing_deck[max_or_min], game_1.trump_suit)
                        ...
                        potential_winner_index = game_1.determine_highest(potential_laid_down)
                        if potential_laid_down[potential_winner_index] == potential_card:
                            print("potential card found to be winner")
                            dec_num = random.random()
                            if current_winning_card.get_value() <= 10:
                                if dec_num < .85:
                                    if other_suits_in_hand_card:
                                        print("other suits in hand != None")
                                        choosing_deck = other_suits_in_hand_card
                                        choosing_deck_values = [Euchre.card_values_nontrump[card] for card in choosing_deck]
                                    print("choosing deck at 2 = " + str(choosing_deck))
                                    print("choosing deck values at 2 =" + str(choosing_deck_values))
                                ...
                                if other_suits_in_hand_card:
                                    print("other suits in hand found")
                                    choosing_deck = other_suits_in_hand_card
                                    choosing_deck_values = [Euchre.card_values_nontrump[card] for card in choosing_deck]
                                print("choosing deck at 2 = " + str(choosing_deck))
                                print("choosing deck values at 2 =" + str(choosing_deck_values))
                            ...
                            if initial_lowest_card_index != highest_card_index and max_or_min != highest_card_index:
                                ...
                                cdvc_count = [i for i in choosing_deck_values_copy if i != 20 and i != choosing_deck_values[highest_card_index]]
                                print("c =" + str(cdvc_count))
                                print("cdvc_count = " + str(cdvc_count))
                                if len(cdvc_count) != 0:
                                    print("code 1")
                                    if max_or_min == initial_lowest_card_index:
                                        max_or_min = lowest_card_index
                    ...
                    potential_laid_down.remove(potential_card)   
                    if card_to_play_index == None:
                        print("card to play index == None")
                        if other_suits_in_hand_card:
                            print("other suits in hand != None")
                            choosing_deck = other_suits_in_hand_card
                            choosing_deck_values = [Euchre.card_values_nontrump[card] for card in choosing_deck]
                        print("choosing deck at 3 = " + str(choosing_deck))
                        print("choosing deck values at 3 =" + str(choosing_deck_values))
                        card_to_play_index = choosing_deck_values.index(min(choosing_deck_values))
                        #testprint
                ...
                while True:
                    ...
                    if choosing_deck[max_or_min] == "jack_lft":
                        for card in player_deck:
                            if card == left_bower:
                                potential_card = card
                    for card in player_deck:
                        print("3333333333333333333333333card name, card suit, choosing deck[max_or_min], trump_suit = ")
                        print(card.get_card_name(), card.get_suit())
                        print(choosing_deck[max_or_min], game_1.trump_suit)
                        if card.get_card_name() == choosing_deck[max_or_min] and card.get_suit() == game_1.trump_suit:
                            print("found a match")
                    ...
                    if potential_laid_down[potential_winner_index] == potential_card:
                        ...
                        if initial_lowest_card_index != highest_card_index and max_or_min != highest_card_index:
                            choosing_deck_values_copy[max_or_min] = 20
                            lowest_card_index = lowest_card_index
                            cdvc_count = [i for i in choosing_deck_values_copy if i != 20 or choosing_deck_values[highest_card_index]]
                            print(lowest_card_index)
                            print(initial_lowest_card_index)
                            print(highest_card_index)
                            cdvc_count = [i for i in choosing_deck_values_copy if i != 20 and i != choosing_deck_values[highest_card_index]]
                ...
                if card_to_play_index == None:
                    ...
                    if other_suits_in_hand_card:
                        ...
                        choosing_deck = other_suits_in_hand_card
                        choosing_deck_values = [Euchre.card_values_nontrump[card] for card in choosing_deck]
                    print("choosing deck at 4 = " + str(choosing_deck))
                    print("choosing deck values at 4 =" + str(choosing_deck_values))
                    card_to_play_index = choosing_deck_values.index(min(choosing_deck_values))
                    #testprint
