...
class Euchre(Card_game):
    ...
    def pick_up(self, trump_card, trump_suit, i = 0, player_responses = []):
        if player_responses == []:
            player_responses = [None, None, None, None]
        player = self.player_order[i]
        column_counter = 0
        ...
        player_label = Label(window, text = "The current player is " + str(player.name)).grid(column = 0, row = 5)
...
class Player:
    ...
    def pick_up_questions_1(self, i, trump_card, trump_suit, dealer, player, dealer_index, player_deck):
        #testprint
        print("player deck in pick up questions 1 " + str(player_deck))
        ...
        pick_up_button = ttk.Button(window, text = "Pick up", command = self.picked_up_print).grid(column = 0, row = 4)
        pass_button = ttk.Button(window, text = "Pass", command = self.picked_up_print).grid(column = 1, row = 4)
